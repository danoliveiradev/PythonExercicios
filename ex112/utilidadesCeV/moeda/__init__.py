def metade(v=0, formato=True):
    ...
    :param formato: recebe verdadeiro ou falso para a formatação do preço (padrão True)
...
def resumo(preco=0, aum=10, red=5):
    ...
    :param preco: recebe preço a ser trabalhado
    :param aum: recebe a % de aumneto
    :param red: recebe a % de redução
    :return: sem retorno
    """
    print('-' * 30)
